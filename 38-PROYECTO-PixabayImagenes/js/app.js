...
function buscarImagenes() {
  ...
  const key = '21852450-6917a73e21ab06ee5d7948d22';
  const url = `https://pixabay.com/api/?key=${key}&page=${paginaActual}&per_page=${registrosPorPagina}&q=${termino.replace(
    ' ',
    '+'
  )}`;
...
function mostrarAlerta(mensaje) {
  ...
  alerta.innerHTML = `
    <strong class="font-bold sm:inline">${mensaje}</strong>
  `;
